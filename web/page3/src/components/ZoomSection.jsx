  ...
  return (
    <section className="zoom-section" ref={sectionRef}>
      <div className="zoom-image-container">
        <img
          ref={imageRef}
          src="https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&q=80&w=1920"
      ...
      <div className="zoom-content" ref={textRef}>
        <p className="zoom-text">
          ...
          <span className="zoom-word">stitch</span>
        ...
        <p className="zoom-subtitle">
          ...
          <span className="zoom-word">unparalleled</span>
          <span className="zoom-word zoom-word-accent">artistry</span>
        </p>
      </div>
    </section>
  );
