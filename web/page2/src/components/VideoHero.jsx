    ...
    <section className="video-hero" ref={heroRef}>
      <div className="video-hero-background">
        <video
          ...
          loop
          playsInline
          poster="https://images.unsplash.com/photo-1523170335258-f5ed11844a49?auto=format&fit=crop&q=80&w=1920"
        >
          <source
            src="https://assets.mixkit.co/videos/preview/mixkit-luxury-watch-with-gold-details-spinning-29949-large.mp4"
            type="video/mp4"
          />
        </video>
      ...
      <div className="video-hero-content">
        <h1 className="hero-title" ref={titleRef}>
          ...
          <span className="hero-word">Precision</span>
        </h1>
        <p className="hero-subtitle" ref={subtitleRef}>
          Swiss Haute Horlogerie Since 1892
        </p>
      </div>
