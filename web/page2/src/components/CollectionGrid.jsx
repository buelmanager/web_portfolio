...
const CollectionGrid = () => {
  ...
  const collections = [
    {
      image: 'https://images.unsplash.com/photo-1612817159949-195b6eb9e31a?auto=format&fit=crop&q=80&w=800&h=1000',
      title: 'Sovereign',
      subtitle: 'Grand Complications',
      year: '2024',
    },
    {
      image: 'https://images.unsplash.com/photo-1622434641406-a158123450f9?auto=format&fit=crop&q=80&w=800&h=600',
      title: 'Celestial',
      subtitle: 'Perpetual Calendar',
      year: '2024',
    },
    {
      image: 'https://images.unsplash.com/photo-1587836374828-4dbafa94cf0e?auto=format&fit=crop&q=80&w=800&h=600',
      title: 'Heritage',
      subtitle: 'Classic Collection',
      year: '2023',
    },
    {
      image: 'https://images.unsplash.com/photo-1548171915-e79a380a2a4b?auto=format&fit=crop&q=80&w=800&h=1000',
      title: 'Meridian',
    ...
    <section className="collection-grid" ref={sectionRef}>
      <div className="collection-header">
        ...
        <p className="collection-intro">
          Explore our exceptional timepieces, each a testament to generations of horological mastery.
        </p>
      </div>
