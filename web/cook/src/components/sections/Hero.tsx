  ...
  return (
    <section id="hero" className="relative w-full h-screen overflow-hidden">
      ...
      {!videoError && (
        ...
        >
          <source 
            src="https://videos.pexels.com/video-files/3201608/3201608-hd_1920_1080_30fps.mp4" 
            type="video/mp4" 
          />
        </video>
      )}
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-200 mb-4 animate-fade-in-up" style={{ animationDelay: '1s' }}>
            master Fine Dining Experience
          </p>
          
          <div className="flex flex-col items-center gap-2 mb-10">
            <span className="text-gray-300">10년 전통 · 시즌 메뉴</span>
            <div className="flex items-baseline gap-2">
              <span className="text-sm text-gray-300">Experience</span>
              <span className="text-3xl md:text-4xl font-bold text-secondary">코스 메뉴</span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#contact"
              className="px-8 py-4 border-2 border-white text-white font-semibold tracking-wide uppercase text-sm transition-all duration-300 hover:bg-white hover:text-primary"
            >
              예약하기
            </a>
          </div>
